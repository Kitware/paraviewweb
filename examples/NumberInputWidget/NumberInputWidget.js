...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["NumberInputWidget"] = __webpack_require__(17);
...
var _NumberInputWidget = __webpack_require__(34);
...
_reactDom2.default.render(_react2.default.createElement(_NumberInputWidget2.default, {
  name: 'sample',
  min: '0',
  max: '100',
  step: '2',
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--21-2!./normalize.css", function() {
			var newContent = require("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--21-2!./normalize.css");
...
var NumberInputWidget = function (_React$Component) {
  _inherits(NumberInputWidget, _React$Component);

  function NumberInputWidget(props) {
    _classCallCheck(this, NumberInputWidget);

    var _this = _possibleConstructorReturn(this, (NumberInputWidget.__proto__ || Object.getPrototypeOf(NumberInputWidget)).call(this, props));
