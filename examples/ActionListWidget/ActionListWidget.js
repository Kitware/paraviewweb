...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["ActionListWidget"] = __webpack_require__(19);
...
}, { name: 'regular', action: 'justMe', icon: 'fa fa-fw ' }, { name: 'a', action: 'a', icon: 'fa fa-fw fa-file-o' }, { name: 'b', action: 'b', icon: 'fa fa-fw fa-file-o' }, { name: 'c', action: 'c', icon: 'fa fa-fw fa-file-o' }];
