...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ColorPickerWidget = __webpack_require__(16);

	var _ColorPickerWidget2 = _interopRequireDefault(_ColorPickerWidget);

	var _defaultSwatches = __webpack_require__(20);
	 ...
	 */
	var ColorPickerWidget = function (_React$Component) {
	  _inherits(ColorPickerWidget, _React$Component);

	  function ColorPickerWidget(props) {
	    _classCallCheck(this, ColorPickerWidget);

	    var _this = _possibleConstructorReturn(this, (ColorPickerWidget.__proto__ || Object.getPrototypeOf(ColorPickerWidget)).call(this, props));

	    _this.image = new Image();
	    _this.image.src = props.swatch;
	    _this.state = {
	      swatch: props.swatch,
	      color: props.color,
	      preview: false,
	    ...
	    // Bind callback
	    _this.showColor = _this.showColor.bind(_this);
	    _this.rgbColorChange = _this.rgbColorChange.bind(_this);
	    _this.updateColor = _this.updateColor.bind(_this);
	    _this.updateSwatch = _this.updateSwatch.bind(_this);
	    return _this;
	  }

	  _createClass(ColorPickerWidget, [{
	    ...
	    key: 'showColor',
	    value: function showColor(event) {
	    ...
	    key: 'rgbColorChange',
	    value: function rgbColorChange(event) {
	    ...
	    key: 'updateSwatch',
	    value: function updateSwatch(url) {
	      this.image.src = url;
	...
	ColorPickerWidget.defaultProps = {
	  color: [0, 0, 0],
	  swatch: _defaultSwatches2.default
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".ColorPickerWidget_container_omMYG {\n    min-width: 5em;\n    width: 100%;\n    box-sizing: border-box;\n    -ms-flex-direction: column;\n        flex-direction: column;\n    display: -ms-flexbox;\n    display: flex;\n}\n\n.ColorPickerWidget_activeColor_bYSCQ {\n    display: -ms-flexbox;\n    display: flex;\n    -ms-flex-direction: row;\n        flex-direction: row;\n    margin-bottom: 10px;\n}\n\n.ColorPickerWidget_colorCanvas_240Rk {\n    -ms-flex: none;\n        flex: none;\n    width: 1.5em;\n    height: 1.5em;\n    border: 1px solid #000;\n    margin-right: 5px;\n}\n\n.ColorPickerWidget_colorRGB_ZyofB {\n    -ms-flex: 1 0 0%;\n        flex: 1 0 0%;\n    min-width: 1em;\n    margin-left: 5px;\n    margin-right: 5px;\n    border: none;\n    text-align: right;\n    padding-right: 10px;\n}\n\n.ColorPickerWidget_swatch_3ldxL {\n    display: -ms-flexbox;\n    display: flex;\n    -ms-flex-direction: row;\n        flex-direction: row;\n    margin-left: 2px;\n    margin-right: 2px;\n}\n\n.ColorPickerWidget_swatchImage_3Fu7z {\n    width: 100%;\n    cursor: crosshair;\n}\n", ""]);

	// exports
	exports.locals = {
		"container": "ColorPickerWidget_container_omMYG",
		"activeColor": "ColorPickerWidget_activeColor_bYSCQ",
		"colorCanvas": "ColorPickerWidget_colorCanvas_240Rk",
		"colorRGB": "ColorPickerWidget_colorRGB_ZyofB",
		"swatch": "ColorPickerWidget_swatch_3ldxL",
		"swatchImage": "ColorPickerWidget_swatchImage_3Fu7z"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	'use strict';var aa=__webpack_require__(2),l=__webpack_require__(23),B=__webpack_require__(5),C=__webpack_require__(7),ba=__webpack_require__(24),da=__webpack_require__(25),ea=__webpack_require__(26),fa=__webpack_require__(27),ia=__webpack_require__(30),D=__webpack_require__(6);
