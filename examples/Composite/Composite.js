...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["Composite"] = __webpack_require__(4);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--66-2!./normalize.css", function() {
			var newContent = require("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--66-2!./normalize.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--59-1!../../node_modules/postcss-loader/lib/index.js??ref--59-2!./Composite.mcss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--59-1!../../node_modules/postcss-loader/lib/index.js??ref--59-2!./Composite.mcss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
