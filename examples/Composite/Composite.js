...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--58-1!../../node_modules/postcss-loader/lib/index.js??ref--58-2!./Composite.mcss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--58-1!../../node_modules/postcss-loader/lib/index.js??ref--58-2!./Composite.mcss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
