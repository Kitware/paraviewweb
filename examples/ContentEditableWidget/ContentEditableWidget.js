...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["ContentEditableWidget"] = __webpack_require__(17);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--30-2!./normalize.css", function() {
			var newContent = require("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--30-2!./normalize.css");
...
var ContentEditableWidget = function (_React$Component) {
  _inherits(ContentEditableWidget, _React$Component);

  function ContentEditableWidget(props) {
    _classCallCheck(this, ContentEditableWidget);

    var _this = _possibleConstructorReturn(this, (ContentEditableWidget.__proto__ || Object.getPrototypeOf(ContentEditableWidget)).call(this, props));

    _this.state = {};

    // Bind callback
    _this.setFocus = _this.setFocus.bind(_this);
    _this.blurEditable = _this.blurEditable.bind(_this);
    _this.emitChange = _this.emitChange.bind(_this);
    return _this;
  }

  _createClass(ContentEditableWidget, [{
    ...
    key: 'blurEditable',
    value: function blurEditable(event) {
...
exports.default = ContentEditableWidget;
