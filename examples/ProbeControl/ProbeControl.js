...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["ProbeControl"] = __webpack_require__(21);
...
var _ProbeControl = __webpack_require__(36);
...
_reactDom2.default.render(_react2.default.createElement(_ProbeControl2.default, { imageBuilder: imageBuilder, imageBuilders: imageBuilders }), container);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--51-2!./normalize.css", function() {
			var newContent = require("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--51-2!./normalize.css");
...
*/
var aa=__webpack_require__(3),l=__webpack_require__(14),B=__webpack_require__(4),C=__webpack_require__(1),ba=__webpack_require__(15),da=__webpack_require__(16),ea=__webpack_require__(17),fa=__webpack_require__(18),ia=__webpack_require__(19),D=__webpack_require__(7);
...
var _NumberSliderWidget = __webpack_require__(41);

var _NumberSliderWidget2 = _interopRequireDefault(_NumberSliderWidget);

var _CollapsibleWidget = __webpack_require__(44);
...
var ProbeControl = function (_React$Component) {
  _inherits(ProbeControl, _React$Component);

  function ProbeControl(props) {
    _classCallCheck(this, ProbeControl);

    var _this = _possibleConstructorReturn(this, (ProbeControl.__proto__ || Object.getPrototypeOf(ProbeControl)).call(this, props));

    var imageBuilder = getImageBuilder(props);
    _this.state = {
    ...
    // Bind callback
    _this.getImageBuilder = getImageBuilder;
    _this.onProbeVisibilityChange = _this.onProbeVisibilityChange.bind(_this);
    _this.getImageBuilder = _this.getImageBuilder.bind(_this);
    _this.attachImageBuilderListeners = _this.attachImageBuilderListeners.bind(_this);
    _this.detachImageBuilderListeners = _this.detachImageBuilderListeners.bind(_this);
    _this.updateRenderMethod = _this.updateRenderMethod.bind(_this);
    _this.probeChange = _this.probeChange.bind(_this);
    return _this;
  }

  _createClass(ProbeControl, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var nextImageBuilder = this.getImageBuilder(nextProps);
    ...
    key: 'onProbeVisibilityChange',
    value: function onProbeVisibilityChange(isProbeOpen) {
      var _this2 = this;
      ...
      setImmediate(function () {
        if (_this2.props.imageBuilders) {
          Object.keys(_this2.props.imageBuilders).forEach(function (key) {
    ...
    key: 'attachImageBuilderListeners',
    value: function attachImageBuilderListeners(imageBuilder) {
      var _this3 = this;
    ...
    key: 'detachImageBuilderListeners',
    value: function detachImageBuilderListeners() {
    ...
    key: 'updateRenderMethod',
    value: function updateRenderMethod(event) {
    ...
    key: 'probeChange',
    value: function probeChange(event) {
    ...
    value: function render() {
      ...
      var value = this.state.field || imageBuilder.getFieldValueAtProbeLocation();
      var valueStr = '' + value;
...
exports.default = ProbeControl;


ProbeControl.propTypes = {
  imageBuilder: _propTypes2.default.object.isRequired,
  imageBuilders: _propTypes2.default.object
};
...
var _NumberSliderWidget = __webpack_require__(42);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--44-1!../../node_modules/postcss-loader/lib/index.js??ref--44-2!./NumberSliderWidget.mcss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--44-1!../../node_modules/postcss-loader/lib/index.js??ref--44-2!./NumberSliderWidget.mcss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var _CollapsibleWidget = __webpack_require__(45);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--44-1!../../node_modules/postcss-loader/lib/index.js??ref--44-2!./CollapsibleWidget.mcss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--44-1!../../node_modules/postcss-loader/lib/index.js??ref--44-2!./CollapsibleWidget.mcss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
exports.locals = {
	...
	"caret": "CollapsibleWidget-caret_37ze4 " + __webpack_require__(2).locals["fa"] + " " + __webpack_require__(2).locals["fa-fw"] + " " + __webpack_require__(2).locals["fa-caret-down"] + "",
	"caretClosed": "CollapsibleWidget-caretClosed_6nggm CollapsibleWidget-caret_37ze4 " + __webpack_require__(2).locals["fa"] + " " + __webpack_require__(2).locals["fa-fw"] + " " + __webpack_require__(2).locals["fa-caret-down"] + "",
