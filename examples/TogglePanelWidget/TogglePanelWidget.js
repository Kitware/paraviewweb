...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["TogglePanelWidget"] = __webpack_require__(26);
...
var _TogglePanelWidget = __webpack_require__(43);

var _TogglePanelWidget2 = _interopRequireDefault(_TogglePanelWidget);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var container = document.querySelector('.content'); // Load CSS
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--11-2!./normalize.css", function() {
			var newContent = require("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--11-2!./normalize.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!../../postcss-loader/lib/index.js??ref--11-2!./font-awesome.css", function() {
			var newContent = require("!!../../css-loader/index.js!../../postcss-loader/lib/index.js??ref--11-2!./font-awesome.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
*/
var aa=__webpack_require__(6),l=__webpack_require__(18),B=__webpack_require__(3),C=__webpack_require__(1),ba=__webpack_require__(19),da=__webpack_require__(20),ea=__webpack_require__(21),fa=__webpack_require__(22),ia=__webpack_require__(23),D=__webpack_require__(7);
...
var _TogglePanelWidget = __webpack_require__(47);
...
var TogglePanelWidget = function (_React$Component) {
  _inherits(TogglePanelWidget, _React$Component);

  function TogglePanelWidget(props) {
    _classCallCheck(this, TogglePanelWidget);

    var _this = _possibleConstructorReturn(this, (TogglePanelWidget.__proto__ || Object.getPrototypeOf(TogglePanelWidget)).call(this, props));
  ...
  _createClass(TogglePanelWidget, [{
    ...
    value: function render() {
      ...
      var panelAnchor = this.props.position.join(' ');
  ...
  return TogglePanelWidget;
}(_react2.default.Component);

exports.default = TogglePanelWidget;
...
TogglePanelWidget.propTypes = {
  ...
  panelVisible: _propTypes2.default.bool,
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--4-1!../../node_modules/postcss-loader/lib/index.js??ref--4-2!./TogglePanelWidget.mcss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--4-1!../../node_modules/postcss-loader/lib/index.js??ref--4-2!./TogglePanelWidget.mcss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".TogglePanelWidget-container_2tp7t {\n    position: relative;\n    display: inline-block;\n    cursor: pointer;\n}\n\n.TogglePanelWidget-content_3paat {\n    position: absolute;\n    z-index: 2;\n}\n\n.TogglePanelWidget-panelVisible_4hmdr {\n}\n\n.TogglePanelWidget-panelHidden_39hus {\n}\n\n.TogglePanelWidget-button_41rfa {\n    position: absolute;\n}\n\n/* Top */\n.TogglePanelWidget-content_3paat.top, .TogglePanelWidget-button_41rfa.top {\n    top: 0;\n}\n\n/* Left */\n.TogglePanelWidget-content_3paat.left, .TogglePanelWidget-button_41rfa.left {\n    left: 0;\n}\n\n/* Right */\n.TogglePanelWidget-content_3paat.right, .TogglePanelWidget-button_41rfa.right {\n    right: 0;\n}\n\n/* Bottom */\n.TogglePanelWidget-content_3paat.bottom, .TogglePanelWidget-button_41rfa.bottom {\n    bottom: 0;\n}\n", ""]);

// exports
exports.locals = {
	"container": "TogglePanelWidget-container_2tp7t",
	"content": "TogglePanelWidget-content_3paat",
	"panelVisible": "TogglePanelWidget-panelVisible_4hmdr " + __webpack_require__(2).locals["fa"] + " " + __webpack_require__(2).locals["fa-fw"] + " " + __webpack_require__(2).locals["fa-eye"] + "",
	"panelHidden": "TogglePanelWidget-panelHidden_39hus " + __webpack_require__(2).locals["fa"] + " " + __webpack_require__(2).locals["fa-fw"] + " " + __webpack_require__(2).locals["fa-eye-slash"] + "",
	"button": "TogglePanelWidget-button_41rfa"
};
