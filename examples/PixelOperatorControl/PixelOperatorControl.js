...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["PixelOperatorControl"] = __webpack_require__(21);
...
var _PixelOperatorControl = __webpack_require__(36);
...
_reactDom2.default.render(_react2.default.createElement(_PixelOperatorControl2.default, { operator: operator }), container);
...
*/
var aa=__webpack_require__(3),l=__webpack_require__(14),B=__webpack_require__(4),C=__webpack_require__(2),ba=__webpack_require__(15),da=__webpack_require__(16),ea=__webpack_require__(17),fa=__webpack_require__(18),ia=__webpack_require__(19),D=__webpack_require__(7);
...
var _CollapsibleWidget = __webpack_require__(39);

var _CollapsibleWidget2 = _interopRequireDefault(_CollapsibleWidget);

var _TextInputWidget = __webpack_require__(48);
...
var PixelOperatorControl = function (_React$Component) {
  _inherits(PixelOperatorControl, _React$Component);

  function PixelOperatorControl(props) {
    _classCallCheck(this, PixelOperatorControl);

    var _this = _possibleConstructorReturn(this, (PixelOperatorControl.__proto__ || Object.getPrototypeOf(PixelOperatorControl)).call(this, props));
  ...
  _createClass(PixelOperatorControl, [{
    ...
    key: 'updateOperation',
    value: function updateOperation(operation) {
      this.setState({
        operation: operation
      });
...
exports.default = PixelOperatorControl;
...
exports.locals = {
	...
	"caret": "CollapsibleWidget-caret_37ze4 " + __webpack_require__(1).locals["fa"] + " " + __webpack_require__(1).locals["fa-fw"] + " " + __webpack_require__(1).locals["fa-caret-down"] + "",
	"caretClosed": "CollapsibleWidget-caretClosed_6nggm CollapsibleWidget-caret_37ze4 " + __webpack_require__(1).locals["fa"] + " " + __webpack_require__(1).locals["fa-fw"] + " " + __webpack_require__(1).locals["fa-caret-down"] + "",
...
var _TextInputWidget = __webpack_require__(51);
...
var TextInputWidget = function (_React$Component) {
  _inherits(TextInputWidget, _React$Component);

  function TextInputWidget(props) {
    _classCallCheck(this, TextInputWidget);

    var _this = _possibleConstructorReturn(this, (TextInputWidget.__proto__ || Object.getPrototypeOf(TextInputWidget)).call(this, props));
      ...
      if (e.key === 'Enter' || e.key === 'Return') {
        ...
        if (this.props.escEndsEdit) {
          ...
          setImmediate(function () {
            _this2.textInput.blur();
            if (!_this2.props.blurEndsEdit) _this2.endEditing();
          });
        }
      }
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('i', {
          className: [this.state.editing ? _TextInputWidget2.default.editingButton : _TextInputWidget2.default.button, this.props.icon].join(' '),
...
TextInputWidget.propTypes = {
  ...
  escEndsEdit: _propTypes2.default.bool,
  blurEndsEdit: _propTypes2.default.bool,
  grabFocus: _propTypes2.default.bool
};
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--45-1!../../node_modules/postcss-loader/lib/index.js??ref--45-2!./TextInputWidget.mcss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--45-1!../../node_modules/postcss-loader/lib/index.js??ref--45-2!./TextInputWidget.mcss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".TextInputWidget-container_4jtpm {\n    width: 100%;\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n}\n\n.TextInputWidget-entry_4akaa {\n    -webkit-box-flex: 1;\n        -ms-flex: 1 0 auto;\n            flex: 1 0 auto;\n}\n\n.TextInputWidget-button_4rsqm {\n\n    margin-left: 10px;\n    -webkit-box-flex: 0;\n        -ms-flex: none;\n            flex: none;\n    cursor: pointer;\n    color: #ccc;\n}\n\n.TextInputWidget-editingButton_39j4h {\n    color: #000;\n}\n\n.TextInputWidget-checkIcon_4vezu {\n}\n", ""]);

// exports
exports.locals = {
	"container": "TextInputWidget-container_4jtpm",
	"entry": "TextInputWidget-entry_4akaa",
	"button": "TextInputWidget-button_4rsqm " + __webpack_require__(1).locals["fa"] + "",
	"editingButton": "TextInputWidget-editingButton_39j4h TextInputWidget-button_4rsqm " + __webpack_require__(1).locals["fa"] + "",
	"checkIcon": "TextInputWidget-checkIcon_4vezu " + __webpack_require__(1).locals["fa-check"] + ""
};
