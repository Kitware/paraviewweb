...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--46-1!../../node_modules/postcss-loader/lib/index.js??ref--46-2!./TextInputWidget.mcss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--46-1!../../node_modules/postcss-loader/lib/index.js??ref--46-2!./TextInputWidget.mcss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
