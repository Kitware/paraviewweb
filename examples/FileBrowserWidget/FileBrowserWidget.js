...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["FileBrowserWidget"] = __webpack_require__(21);
...
var _FileBrowserWidget = __webpack_require__(36);
...
(0, _reactDom.render)(_react2.default.createElement(_FileBrowserWidget2.default, {
  directories: ['a', 'b', 'c'],
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--25-2!./normalize.css", function() {
			var newContent = require("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--25-2!./normalize.css");
...
*/
var aa=__webpack_require__(3),l=__webpack_require__(12),B=__webpack_require__(4),C=__webpack_require__(2),ba=__webpack_require__(13),da=__webpack_require__(14),ea=__webpack_require__(15),fa=__webpack_require__(16),ia=__webpack_require__(17),D=__webpack_require__(7);
...
var _ActionListWidget = __webpack_require__(47);
...
var FileBrowserWidget = function (_React$Component) {
  _inherits(FileBrowserWidget, _React$Component);

  function FileBrowserWidget(props) {
    _classCallCheck(this, FileBrowserWidget);

    var _this = _possibleConstructorReturn(this, (FileBrowserWidget.__proto__ || Object.getPrototypeOf(FileBrowserWidget)).call(this, props));
    ...
    // Bind callback
    _this.onPathChange = _this.onPathChange.bind(_this);
    _this.onAction = _this.onAction.bind(_this);
    return _this;
  }

  _createClass(FileBrowserWidget, [{
    ...
    key: 'onAction',
    value: function onAction(name, action, data) {
    ...
    key: 'onPathChange',
    value: function onPathChange(event) {
        ...
        _react2.default.createElement(
          ...
          this.props.path.map(function (name, idx) {
            return _react2.default.createElement(
              'li',
              {
                className: _FileBrowserWidget2.default.breadcrumbItem,
                key: idx,
                'data-idx': idx,
                title: name,
                onClick: _this2.onPathChange
              },
...
exports.default = FileBrowserWidget;
FileBrowserWidget.propTypes = {
  directories: _propTypes2.default.array.isRequired,
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--18-1!../../node_modules/postcss-loader/lib/index.js??ref--18-2!./FileBrowserWidget.mcss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--18-1!../../node_modules/postcss-loader/lib/index.js??ref--18-2!./FileBrowserWidget.mcss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".FileBrowserWidget-container_26tcu {\n}\n\n.FileBrowserWidget-breadcrumb_jkh6r {\n    width: 100%;\n    position: relative;\n    list-style: none;\n    padding: 0;\n    margin: 0;\n    border-bottom: 1px solid #d0d0d0;\n    line-height: 30px;\n    vertical-align: middle;\n}\n\n.FileBrowserWidget-breadcrumbItem_3hzz3 {\n    display: inline;\n    padding-left: 10px;\n    color: #555;\n    cursor: pointer;\n}\n\n.FileBrowserWidget-breadcrumbItem_3hzz3:before {\n    content: '\\\\';\n    position: relative;\n    left: -5px;\n}\n\n.FileBrowserWidget-breadcrumbLabel_2a2yu {\n    position: absolute;\n    right: 10px;\n    display: none;\n    width: 50%;\n\n    text-align: right;\n    white-space: nowrap;\n    overflow: hidden;\n    text-overflow: ellipsis;\n}\n\n.FileBrowserWidget-breadcrumbItem_3hzz3:hover {\n    color: black;\n}\n\n.FileBrowserWidget-breadcrumbItem_3hzz3:hover ~ .FileBrowserWidget-breadcrumbItem_3hzz3 {\n    color: #555;\n}\n\n.FileBrowserWidget-breadcrumbItem_3hzz3:hover .FileBrowserWidget-breadcrumbLabel_2a2yu {\n    display: inline-block;\n}\n\n.FileBrowserWidget-breadcrumbItem_3hzz3:last-child {\n    color: black;\n}\n\n.FileBrowserWidget-breadcrumbItem_3hzz3:last-child .FileBrowserWidget-breadcrumbLabel_2a2yu {\n    display: inline-block;\n}\n\nli:hover ~ li:last-child .FileBrowserWidget-breadcrumbLabel_2a2yu {\n    display: none;\n}\n\n.FileBrowserWidget-breadcrumbFolderIcon_bt6ss {\n}\n\n.FileBrowserWidget-folderIcon_v6d53 {\n}\n\n.FileBrowserWidget-groupIcon_4pvrx {\n}\n\n.FileBrowserWidget-fileIcon_27nkz {\n}\n", ""]);

// exports
exports.locals = {
	"container": "FileBrowserWidget-container_26tcu",
	"breadcrumb": "FileBrowserWidget-breadcrumb_jkh6r",
	"breadcrumbItem": "FileBrowserWidget-breadcrumbItem_3hzz3",
	"breadcrumbLabel": "FileBrowserWidget-breadcrumbLabel_2a2yu",
	"breadcrumbFolderIcon": "FileBrowserWidget-breadcrumbFolderIcon_bt6ss " + __webpack_require__(0).locals["fa"] + " " + __webpack_require__(0).locals["fa-fw"] + " " + __webpack_require__(0).locals["fa-folder-open"] + "",
	"folderIcon": "FileBrowserWidget-folderIcon_v6d53 " + __webpack_require__(0).locals["fa"] + " " + __webpack_require__(0).locals["fa-fw"] + " " + __webpack_require__(0).locals["fa-folder-o"] + "",
	"groupIcon": "FileBrowserWidget-groupIcon_4pvrx " + __webpack_require__(0).locals["fa"] + " " + __webpack_require__(0).locals["fa-fw"] + " " + __webpack_require__(0).locals["fa-files-o"] + "",
	"fileIcon": "FileBrowserWidget-fileIcon_27nkz " + __webpack_require__(0).locals["fa"] + " " + __webpack_require__(0).locals["fa-fw"] + " " + __webpack_require__(0).locals["fa-file-text-o"] + ""
};
...
var _ActionListWidget = __webpack_require__(48);
...
var ActionListWidget = function (_React$Component) {
  _inherits(ActionListWidget, _React$Component);

  function ActionListWidget(props) {
    _classCallCheck(this, ActionListWidget);

    // Bind callback
    var _this = _possibleConstructorReturn(this, (ActionListWidget.__proto__ || Object.getPrototypeOf(ActionListWidget)).call(this, props));

    _this.processClick = _this.processClick.bind(_this);
    return _this;
  }

  _createClass(ActionListWidget, [{
    key: 'processClick',
...
exports.default = ActionListWidget;
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--18-1!../../node_modules/postcss-loader/lib/index.js??ref--18-2!./ActionListWidget.mcss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--18-1!../../node_modules/postcss-loader/lib/index.js??ref--18-2!./ActionListWidget.mcss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".ActionListWidget-list_3jatc {\n    list-style: none;\n    margin: 0;\n    padding: 0;\n    width: 100%;\n}\n\n.ActionListWidget-item_gb4jg {\n    color: #333;\n    padding: 5px;\n    cursor: pointer;\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n\n    white-space: nowrap;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    -webkit-box-sizing: border-box;\n            box-sizing: border-box;\n    height: 32px;\n}\n\n.ActionListWidget-activeItem_ps5fc {\n  background: #ccc;\n  color: #000;\n  border-bottom: 1px solid #999;\n  border-top: 1px solid #999;\n}\n\n.ActionListWidget-item_gb4jg:hover {\n    background: #333;\n    color: #eee;\n}\n", ""]);

// exports
exports.locals = {
	"list": "ActionListWidget-list_3jatc",
	"item": "ActionListWidget-item_gb4jg",
	"activeItem": "ActionListWidget-activeItem_ps5fc ActionListWidget-item_gb4jg"
};
