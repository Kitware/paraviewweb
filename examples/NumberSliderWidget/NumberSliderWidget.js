...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--20-2!./normalize.css", function() {
			var newContent = require("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--20-2!./normalize.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--13-1!../../node_modules/postcss-loader/lib/index.js??ref--13-2!./NumberSliderWidget.mcss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--13-1!../../node_modules/postcss-loader/lib/index.js??ref--13-2!./NumberSliderWidget.mcss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
