...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["NumberSliderWidget"] = __webpack_require__(19);
...
var ColorField = function (_React$Component) {
  ...
  function ColorField(props) {
    ...
    _this.drawColor = _this.drawColor.bind(_this);
    return _this;
  }
  ...
  _createClass(ColorField, [{
    ...
    value: function render() {
      ...
      var _ref = [this.state.r, this.state.g, this.state.b],
          r = _ref[0],
          g = _ref[1],
          b = _ref[2];
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--19-2!./normalize.css", function() {
			var newContent = require("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--19-2!./normalize.css");
...
var _NumberSliderWidget = __webpack_require__(38);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--12-1!../../node_modules/postcss-loader/lib/index.js??ref--12-2!./NumberSliderWidget.mcss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--12-1!../../node_modules/postcss-loader/lib/index.js??ref--12-2!./NumberSliderWidget.mcss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
