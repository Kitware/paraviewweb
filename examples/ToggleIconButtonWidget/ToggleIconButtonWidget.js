...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["ToggleIconButtonWidget"] = __webpack_require__(26);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--12-2!./normalize.css", function() {
			var newContent = require("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--12-2!./normalize.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!../../postcss-loader/lib/index.js??ref--12-2!./font-awesome.css", function() {
			var newContent = require("!!../../css-loader/index.js!../../postcss-loader/lib/index.js??ref--12-2!./font-awesome.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var _ToggleIconButtonWidget = __webpack_require__(47);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js??ref--5-1!../../node_modules/postcss-loader/lib/index.js??ref--5-2!./ToggleIconButtonWidget.mcss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js??ref--5-1!../../node_modules/postcss-loader/lib/index.js??ref--5-2!./ToggleIconButtonWidget.mcss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// exports
exports.locals = {
	"button": "ToggleIconButtonWidget-button_3y7ee " + __webpack_require__(2).locals["fa"] + " " + __webpack_require__(2).locals["fa-fw"] + "",
	"enabledButton": "ToggleIconButtonWidget-enabledButton_4cyat ToggleIconButtonWidget-button_3y7ee " + __webpack_require__(2).locals["fa"] + " " + __webpack_require__(2).locals["fa-fw"] + "",
	"disabledButton": "ToggleIconButtonWidget-disabledButton_4kkvx ToggleIconButtonWidget-button_3y7ee " + __webpack_require__(2).locals["fa"] + " " + __webpack_require__(2).locals["fa-fw"] + ""
};
