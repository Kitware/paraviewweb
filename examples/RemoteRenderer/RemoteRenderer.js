...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SmartConnect = __webpack_require__(1);
	...
	var _SizeHelper = __webpack_require__(28);

	var _SizeHelper2 = _interopRequireDefault(_SizeHelper);

	var _ParaViewWebClient = __webpack_require__(31);
	...
	var smartConnect = _SmartConnect2.default.newInstance({ config: config });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.newInstance = exports.DEFAULT_SESSION_URL = exports.DEFAULT_SESSION_MANAGER_URL = undefined;
	...
	var _ProcessLauncher = __webpack_require__(5);

	var _ProcessLauncher2 = _interopRequireDefault(_ProcessLauncher);

	var _WebsocketConnection = __webpack_require__(6);

	var _WebsocketConnection2 = _interopRequireDefault(_WebsocketConnection);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var DEFAULT_SESSION_MANAGER_URL = exports.DEFAULT_SESSION_MANAGER_URL = window.location.protocol + '//' + window.location.hostname + ':' + window.location.port + '/paraview/',
	    DEFAULT_SESSION_URL = exports.DEFAULT_SESSION_URL = (window.location.protocol === 'https' ? 'wss' : 'ws') + '://' + window.location.hostname + ':' + window.location.port + '/ws'; /* global window */
	...
	function smartConnect(publicAPI, model) {
	  ...
	  publicAPI.connect = function () {
	    if (model.config.sessionURL) {
	      ...
	      var launcher = _ProcessLauncher2.default.newInstance({ endPoint: model.config.sessionManagerURL || DEFAULT_SESSION_MANAGER_URL });
	  ...
	  publicAPI.destroy = _CompositeClosureHelper2.default.chain(cleanUp, publicAPI.destroy);
	}
	...
	function extend(publicAPI, model) {
	  ...
	  _CompositeClosureHelper2.default.event(publicAPI, model, 'ConnectionReady');
	  _CompositeClosureHelper2.default.event(publicAPI, model, 'ConnectionClose');
	  _CompositeClosureHelper2.default.event(publicAPI, model, 'ConnectionError');
	  _CompositeClosureHelper2.default.isA(publicAPI, model, 'SmartConnect');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var connections = []; /* global XMLHttpRequest */
	...
	function extend(publicAPI, model) {
	  ...
	  _CompositeClosureHelper2.default.destroy(publicAPI, model);
	  _CompositeClosureHelper2.default.event(publicAPI, model, 'ProcessReady');
	  _CompositeClosureHelper2.default.event(publicAPI, model, 'ProcessStopped');
	  _CompositeClosureHelper2.default.event(publicAPI, model, 'Fetch');
	  _CompositeClosureHelper2.default.event(publicAPI, model, 'Error');
	  _CompositeClosureHelper2.default.isA(publicAPI, model, 'ProcessLauncher');
...
/***/ function(module, exports, __webpack_require__) {
	...
	function WebsocketConnection(publicAPI, model) {
	  ...
	  publicAPI.connect = function () {
	    ...
	    model.session = _session2.default.newInstance({ ws: model.connection, secret: model.secret });
	...
	function extend(publicAPI, model) {
	  ...
	  _CompositeClosureHelper2.default.event(publicAPI, model, 'ConnectionClose');
	  _CompositeClosureHelper2.default.event(publicAPI, model, 'ConnectionError');
	  _CompositeClosureHelper2.default.isA(publicAPI, model, 'WebsocketConnection');
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Session(publicAPI, model) {
	  ...
	  publicAPI.call = function (method) {
	    ...
	    if (model.ws && clientID && model.ws.readyState === 1) {
	      var id = 'rpc:' + clientID + ':' + msgCount++;
	      inFlightRpc[id] = deferred;
	      model.ws.send(JSON.stringify({ wslink: '1.0', id: id, method: method, args: args, kwargs: kwargs }));
	    } else {
	  ...
	  publicAPI.subscribe = function (topic, callback) {
	    ...
	    if (model.ws && clientID) {
	      ...
	      deferred.resolve({ topic: topic, callback: callback });
	    } else {
	    ...
	    if (event.data instanceof ArrayBuffer || event.data instanceof Blob) {
	      ...
	      if (!payload.id) {
	        ...
	        if (payload.method === 'wslink.binary.attachment') {
	          payload.args.forEach(function (key) {
	            attachments.push({ key: key, data: null });
	          });
	        }
	        return;
	      }
	      if (payload.error) {
	        ...
	        if (payload.result && attachments.length > 0) {
	          ...
	          for (var key in payload.result) {
	            if (typeof payload.result[key] === 'string' && regexAttach.test(payload.result[key])) {
	              (function () {
	                var binaryKey = payload.result[key];
	        ...
	        if (match) {
	          ...
	          if (type === 'rpc') {
	            ...
	            if (payload.id === 'system:c0:0') {
	              ...
	              if (_deferred2) _deferred2.reject({ code: CLIENT_ERROR, message: 'Unknown system message ' + payload.id });
	            }
	          } else {
	...
	function extend(publicAPI, model) {
	  ...
	  _CompositeClosureHelper2.default.destroy(publicAPI, model);
	  _CompositeClosureHelper2.default.isA(publicAPI, model, 'Session');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _monologue = __webpack_require__(9);

	var _monologue2 = _interopRequireDefault(_monologue);

	var _MouseHandler = __webpack_require__(14);

	var _MouseHandler2 = _interopRequireDefault(_MouseHandler);

	var _VtkWebMouseListener = __webpack_require__(27);
	...
	var RemoteRenderer = function () {
	  function RemoteRenderer(pvwClient) {
	    ...
	    this.mouseListener = new _VtkWebMouseListener2.default(pvwClient, 100, 100, id);
...
/***/ function(module, exports, __webpack_require__) {
	...
	( function( root, factory ) {
		...
		if ( true ) {
			...
			!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(10), __webpack_require__(12) ], __WEBPACK_AMD_DEFINE_RESULT__ = function( _, riveter ) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (root, factory) {
	    if (true) {
	        // AMD. Register as an anonymous module.
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(13)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hammerjs = __webpack_require__(15);
	...
	var MouseHandler = function () {
	  function MouseHandler(domElement, options) {
	    ...
	    this.domEventHandler = function (e) {
	      ...
	      if (!_this.inRightClickHandling && ['mousemove', 'mouseup'].indexOf(e.type) !== -1) {
	        return true;
	      ...
	      var event = {
	        srcEvent: e,
	        button: _this.inRightClickHandling ? 2 : 0,
	      ...
	      if (e.type === 'mouseup') {
	        _this.inRightClickHandling = false;
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(17), __webpack_require__(18), __webpack_require__(25)], __WEBPACK_AMD_DEFINE_RESULT__ = function (hasOwn, deepClone, isObject) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(19), __webpack_require__(23), __webpack_require__(20), __webpack_require__(21)], __WEBPACK_AMD_DEFINE_RESULT__ = function (clone, forOwn, kindOf, isPlainObject) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(20), __webpack_require__(21), __webpack_require__(22)], __WEBPACK_AMD_DEFINE_RESULT__ = function (kindOf, isPlainObject, mixIn) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(23)], __WEBPACK_AMD_DEFINE_RESULT__ = function(forOwn){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(17), __webpack_require__(24)], __WEBPACK_AMD_DEFINE_RESULT__ = function (hasOwn, forIn) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(17)], __WEBPACK_AMD_DEFINE_RESULT__ = function (hasOwn) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(26)], __WEBPACK_AMD_DEFINE_RESULT__ = function (isKind) {
	    /**
	     */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(20)], __WEBPACK_AMD_DEFINE_RESULT__ = function (kindOf) {
	    /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VtkMouseListener = function () {
	  function VtkMouseListener(vtkWebClient) {
	    ...
	    var viewId = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : -1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ColorManager = __webpack_require__(32);

	var _ColorManager2 = _interopRequireDefault(_ColorManager);

	var _FileListing = __webpack_require__(33);

	var _FileListing2 = _interopRequireDefault(_FileListing);

	var _KeyValuePairStore = __webpack_require__(34);

	var _KeyValuePairStore2 = _interopRequireDefault(_KeyValuePairStore);

	var _MouseHandler = __webpack_require__(35);

	var _MouseHandler2 = _interopRequireDefault(_MouseHandler);

	var _ProxyManager = __webpack_require__(36);

	var _ProxyManager2 = _interopRequireDefault(_ProxyManager);

	var _SaveData = __webpack_require__(37);

	var _SaveData2 = _interopRequireDefault(_SaveData);

	var _TimeHandler = __webpack_require__(38);
	...
	var protocolsMap = {
	  ...
	  VtkGeometryDelivery: _VtkGeometryDelivery2.default,
	  VtkImageDelivery: _VtkImageDelivery2.default
	};
...
/***/ function(module, exports) {
	...
	function createMethods(session) {
	  return {
	    ...
	    offViewChange: function offViewChange(subscription) {
	      return session.unsubscribe(subscription);
	    },
	    addViewObserver: function addViewObserver(viewId) {
	      return session.call('viewport.geometry.view.observer.add', [viewId]);
	    },
	    removeViewObserver: function removeViewObserver(viewId) {
...
/***/ function(module, exports) {
	...
	function createMethods(session) {
	  return {
	    ...
	    onRenderChange: function onRenderChange(callback) {
	      return session.subscribe('viewport.image.push.subscription', callback);
	    },
	    offRenderChange: function offRenderChange(subscription) {
	      return session.unsubscribe(subscription);
	    },
	    addRenderObserver: function addRenderObserver(viewId) {
	      return session.call('viewport.image.push.observer.add', [viewId]);
	    },
	    removeRenderObserver: function removeRenderObserver(viewId) {
