...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["RemoteRenderer"] = __webpack_require__(6);
...
smartConnect.onConnectionReady(function (connection) {
  ...
  var renderer = new _RemoteRenderer2.default(pvwClient);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--58-2!./normalize.css", function() {
			var newContent = require("!!../css-loader/index.js!../postcss-loader/lib/index.js??ref--58-2!./normalize.css");
...
var _CompositeClosureHelper = __webpack_require__(1);

var _CompositeClosureHelper2 = _interopRequireDefault(_CompositeClosureHelper);

var _ProcessLauncher = __webpack_require__(16);

var _ProcessLauncher2 = _interopRequireDefault(_ProcessLauncher);

var _WebsocketConnection = __webpack_require__(17);
...
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; // Helper borrowed from paraviewweb/src/Common/Core
...
var _MouseHandler = __webpack_require__(23);

var _MouseHandler2 = _interopRequireDefault(_MouseHandler);

var _VtkWebMouseListener = __webpack_require__(25);
...
var _hammerjs = __webpack_require__(24);
...
var INTERATION_TOPIC = 'vtk.web.interaction';
  ...
  function VtkMouseListener(vtkWebClient) {
    ...
    this.listeners = {
      drag: function drag(event) {
        ...
        if (_this.client) {
          ...
          if (tNow > _this.lastEventTime + _this.throttleTime || vtkEvent.action !== 'move') {
            ...
            if (vtkEvent.action !== 'move' && _this.lastEvent) {
              ...
              if (_this.lastEvent.action !== vtkEvent.action && vtkEvent.action === 'down') {
                _this.lastEvent = vtkEvent;
                return;
              }
              // eat second up action
              if (_this.lastEvent.action === vtkEvent.action && vtkEvent.action === 'up') {
                _this.lastEvent = vtkEvent;
                return;
              }
            }
        ...
        if (vtkEvent.action === 'up') {
          _this.emit(INTERATION_TOPIC, false);
        }
      },
