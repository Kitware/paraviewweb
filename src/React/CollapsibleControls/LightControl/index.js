                ...
                <Coordinate2DWidget onChange={this.onLightPositionChange} width={114} height={114} hideXY/>
                    <section className={ style.controls }>
                        <div className={ style.inputRow }>
                            <label>Ambient</label><NumberInputWidget className={ style.property } step={0.05} min={0.0} max={1.0}
                                key="ka" value={this.state.ka} name='ka' onChange={this.onLightTermsChange}/>
                        </div>
                        <div className={ style.inputRow }>
                            <label>Diffuse</label><NumberInputWidget className={ style.property } step={0.05} min={0.0} max={1.0}
                                key="kd" value={this.state.kd} name='kd' onChange={this.onLightTermsChange}/>
                        </div>
                        <div className={ style.inputRow }>
                            <label>Specular</label><NumberInputWidget className={ style.property } step={0.05} min={0.0} max={1.0}
                                key="ks" value={this.state.ks} name='ks' onChange={this.onLightTermsChange}/>
                        </div>
                        <div className={ style.inputRow }>
                            <label>Alpha</label><NumberInputWidget className={ style.property } step={1} min={0.0} max={100}
