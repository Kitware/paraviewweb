...
export default class DataProberImageBuilder extends AbstractImageBuilder {
    ...
    constructor(queryDataModel, lookupTableManager) {
        super({ queryDataModel, lookupTableManager });
    ...
    getControlWidgets() {
        var { lookupTable, originalRange, lookupTableManager, queryDataModel } = this.getControlModels(),
            model = this;
        return [
            {
                name: "LookupTableManagerWidget",
                lookupTable, originalRange, lookupTableManager,
            },{
                name: "ProbeControl",
                model,
            },{
