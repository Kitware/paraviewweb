...
export default function({client, filterQuery, mustContain, busy, encodeQueryAsString}) {
    return {
        ...
        updateItemMetadata(id, metadata={}) {
            return busy(client._.put(`/item/${id}/metadata`, metadata, { transformRequest: jsonToString }));
        },
        ...
        listItems(query={}) {
            ...
            return busy(client._.get('/item', { params }));
        },
        ...
        listFiles(id, query) {
            ...
            return busy(client._.get(`/item/${id}/files`, { params }));
        },
