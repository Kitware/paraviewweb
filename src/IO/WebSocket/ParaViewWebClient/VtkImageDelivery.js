...
export default function createMethods(session) {
  return {
    stillRender: (options = { size: [400, 400], view: -1 }) => session.call('viewport.image.push', [options]),
    onRenderChange: callback => session.subscribe('viewport.image.push.subscription', callback),
